...
scrollTirggerAnimation(".featured", [".featured .box1", ".featured .box2", ".featured .box3"]);

swipeAnimation(".items", [".items .heading", ".items .content"])

galleryAnimation(".items .gallery", [".items .gallery .box1",".items .gallery .box2",".items .gallery .box3",".items .gallery .box4",".items .gallery .box5"])

swipeAnimation(".article", [".article .latest-article", ".article .box1", ".article .box2", ".article .box3", ".article .box4"])

galleryAnimation(".preminum .gallery", [".preminum .gallery .box1",".preminum .gallery .box2",".preminum .gallery .box3",".preminum .gallery .box4",".preminum .gallery .box5"])
